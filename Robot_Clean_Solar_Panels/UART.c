...
static void init_UART4(void){	
  ...
  /* GPIO Configuration for UART4 Tx & Rx */
...
//		if (a[0] == 'R' && a[1] == 'S' && a[2] == 'T'){
//				rcv_flag = 1;
//				for (i = 5; i<BUFF_SIZE_RX; i++) a[i] = 0;
//		}
//		else if (a[0] == 'E' && a[1] == 'M' && a[2] == 'E' && a[3] == 'R') rcv_flag = 2; 
//		else if (a[0] == 'S' || a[0] == 'R' || a[0] == 'L' || a[0] == 'F' || a[0] == 'B') rcv_flag = 3;
